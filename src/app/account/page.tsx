...
export default function AccountPage() {
  const { user, orders, wishlist, logoutUser, loginUser, loginWithGoogle, loginWithEmail, showToast } = useShop();
  ...
  if (!user) {
    return (
      <div className="max-w-md mx-auto px-4 py-20">
        <div className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-2xl space-y-6">
          <div className="text-center space-y-2">
            <h1 className="text-2xl font-serif font-bold text-zinc-900">
              Customer Account Portal
            </h1>
            <p className="text-xs text-zinc-500">
              Sign in to track Texvalley orders, manage addresses, and access store wallet.
            </p>
          </div>
          ...
          >
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-zinc-50 border border-zinc-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#C8A24D]"
              />
            </div>
